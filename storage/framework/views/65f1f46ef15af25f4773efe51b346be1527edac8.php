...
<?php $__env->startSection('container'); ?>
    ...
    <ul class="list">
        ...
        <li class="list__item <?php echo e(class_exists('ZipArchive') ? 'success' : 'error'); ?>">
            ZipArchive
            <i class="fa fa-fw fa-<?php echo e(class_exists('ZipArchive') ? 'check-circle-o' : 'exclamation-circle'); ?> row-icon" aria-hidden="true"></i>
        </li>
    </ul>

    <?php if( ! isset($requirements['errors']) && $phpSupportInfo['supported'] && class_exists('ZipArchive')): ?>
        <div class="buttons">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('vendor.installer.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Github\restro-saas-taluu\resources\views/vendor/installer/requirements.blade.php ENDPATH**/ ?>