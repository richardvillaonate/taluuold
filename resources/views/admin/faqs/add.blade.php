                    ...
                    <form action="{{ URL::to('/admin/faqs/save') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="question"
                                    value="{{ old('question') }}" placeholder="{{ trans('labels.question') }}"
                                    required>
                                @error('question')
                        ...
                        <div class="form-group text-end">
                            ...
                            <button
                                ...
                                class="btn btn-success btn-succes m-1 {{ Auth::user()->type == 4 ? (helper::check_access('role_faqs', Auth::user()->role_id, $vendor_id, 'add') == 1 ? '' : 'd-none') : '' }}">{{ trans('labels.save') }}</button>
                        </div>
                    </form>
                </div>
            </div>
